...
Runtime::Rect_t Multiline_TextWidth_WithCyrilic(const std::string& text, int fontSize);
void Render_String(SDL_Renderer* renerer, Runtime::Rect_t rect, const char* text, int len,
